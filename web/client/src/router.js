  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'account', component: () => import('./views/account/AccountShell.vue'), meta: { requiresAuth: true, title: 'My Account', noindex: true }, children: [
          ...
          /* 取消/退款三步挽留向导（列表/详情不再直达取消；reason=user_wizard:* 供归因） */
          { path: 'orders/cancel', name: 'account-order-cancel', component: () => import('./views/account/CancelFlowView.vue'), meta: { title: 'Cancel Order', noindex: true } },
          { path: 'returns', name: 'account-returns', component: () => import('./views/account/ReturnsView.vue'), meta: { title: 'After-sales' } },
          { path: 'points', name: 'account-points', component: () => import('./views/account/PointsView.vue'), meta: { title: 'Glow Points' } },
          { path: 'coupons', name: 'account-coupons', component: () => import('./views/account/MyCouponsView.vue'), meta: { title: 'My Coupons' } },
        ...
        { path: 'coupons', name: 'coupons', component: () => import('./views/CouponsView.vue'), meta: { title: 'Coupon Center' } },
