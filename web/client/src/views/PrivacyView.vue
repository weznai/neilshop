...
<template>
  <section class="section">
    <div class="container" style="max-width:960px">
      ...
      <div class="meta-row">
        <span>{{ tt('Last updated: Aug 2026', '最后更新：2026 年 8 月') }}</span><span class="meta-dot" /><span>{{ tt('GDPR & CCPA aligned', '符合 GDPR 与 CCPA') }}</span>
      ...
      <div class="policy-grid" style="display:grid;grid-template-columns:200px 1fr;gap:32px">
        ...
        <article class="prose">
          ...
          <h2 id="collect" style="scroll-margin-top:90px">{{ tt('1 · What we collect', '1 · 我们收集哪些信息') }}</h2>
          ...
          <h2 id="use" style="scroll-margin-top:90px">{{ tt('2 · How we use it', '2 · 我们如何使用') }}</h2>
          ...
          <h2 id="ccpa" style="scroll-margin-top:90px">{{ tt('3 · Your rights (CCPA)', '3 · 你的权利（CCPA）') }}</h2>
          ...
          <h2 id="gdpr" style="scroll-margin-top:90px">{{ tt('4 · Your rights (GDPR)', '4 · 你的权利（GDPR）') }}</h2>
          ...
          <h2 id="cookies" style="scroll-margin-top:90px">{{ tt('5 · Cookies', '5 · Cookie') }}</h2>
          ...
          <h2 id="retention" style="scroll-margin-top:90px">{{ tt('6 · Retention', '6 · 数据保留') }}</h2>
          ...
          <h2 id="contact" style="scroll-margin-top:90px">{{ tt('7 · Contact', '7 · 联系我们') }}</h2>
