...
<template>
  <section class="section">
    <div class="container" style="max-width:960px">
      ...
      <div class="meta-row">
        <span>{{ updatedLabel(tt) }}</span><span class="meta-dot" /><span>{{ tt('By using glowmag.com you agree to these terms', '使用 glowmag.com 即表示你同意以下条款') }}</span>
      ...
      <div class="policy-grid" style="display:grid;grid-template-columns:200px 1fr;gap:32px">
        ...
        <article class="prose">
          <p>{{ tt('A quick intro: these terms cover the basics of shopping with GLOWMAG, in plain language and without fine-print traps.', '先说一句：以下条款涵盖了在 GLOWMAG 购物的基本规则——直白表述，不玩文字游戏。') }}</p>
          <h2 id="orders" style="scroll-margin-top:84px">{{ tt('1 · Orders & payment', '1 · 订单与支付') }}</h2>
          ...
          <h2 id="shipping" style="scroll-margin-top:84px">{{ tt('2 · Shipping', '2 · 配送') }}</h2>
          ...
          <h2 id="returns" style="scroll-margin-top:84px">{{ tt('3 · Returns & exchanges', '3 · 退换货') }}</h2>
          ...
          <h2 id="ip" style="scroll-margin-top:84px">{{ tt('4 · Intellectual property', '4 · 知识产权') }}</h2>
          ...
          <h2 id="liability" style="scroll-margin-top:84px">{{ tt('5 · Liability', '5 · 责任') }}</h2>
          ...
          <h2 id="law" style="scroll-margin-top:84px">{{ tt('6 · Governing law', '6 · 适用法律') }}</h2>
